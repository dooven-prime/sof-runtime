...
I discovered nine SOF Runtime MCP tools and explicitly queried `service-request.schema.json`. The returned SHA-256 was `875c53bb39f0627d2e3e8d8dd572a98480a76f610dd6515d96e0e6caba8fc407`.

Both supplied cases were `canonical_compilable`, so I completed the strongest admitted chain: reference/target realization, SOFRS reporting, explicit aligned comparison, and context/policy-relative interpretation. All applicable report, audit, action, and receipt validations succeeded.

The sole requested comparison coordinate, `operator.support.summary`, is `MISMATCH`: reference support count 2, target support count 3, exact absolute difference 1 support pair. This is a Computational Observation under the declared alignment. The audit-level recomputation is a Computational Certificate, but the reference is only a declared baseline—not a truth oracle—and the mismatch does not establish defect, severity, or action.

The admitted policy yielded two bounded candidates: `investigate:operator.support.summary` (Investigate) and `requestevidence:operator.support.summary` (RequestEvidence). Both have `authorization_state: not_requested`. Neither is selected, recommended, authorized, executed, or evidence of an outcome or causal effect.

Unsupported capabilities are route filtration, positive-word depth, Lie/Hall depth, and deformation chart. Associative and closure modules remain unavailable because their required carriers, object kinds, cutoff, or saturation audit are absent.

Ordered principal artifact chain:

1. Reference realization candidate — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/realization/candidate.json` — `3559dd19203b73a14c22b38987055f5a4f1d26c4dc1bdf2ff8b42aa1cf9573f3`
2. Reference report — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-report/report/result.sofreport.json` — `166b0de4269bbde554baaac4b07214436942d3a9bfcecd1c073c2ee924c33ae1`
3. Reference report receipt — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-report/report/validation-receipt.json` — `ef16e622b0e9e05d8f621d87792d100cdb701edd0ae169fcc4bed75cbc23b2b5`
4. Target realization candidate — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/realization/candidate.json` — `c120c334d96cf906c3278c9132984345e9da4e87b2a44c863818f99916129907`
5. Target report — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-report/report/result.sofreport.json` — `bc783aee6c4705ea535a4e8bfd97c696e26b4db3fe81c8d4deb76dbe93dc29dd`
6. Target report receipt — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-report/report/validation-receipt.json` — `89c7fc342ae0cdd56f2bed4bf0b62a213f271fd87747de97f86d70cf7d14b14b`
7. SOFAUDIT — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/comparison/result.sofaudit.json` — `40125672cfd042eaf8ac737055c9a07dd069b6263aeecab6ce67f31e1a8a95ef`
8. SOFAUDIT receipt — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/comparison/validation-receipt.json` — `8cb9ccbce7fa6711ff452f3a4c8a818bbb00e35fa2f0eebb573484cbd5e30f07`
9. SOFAction — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/action/result.sofaction.json` — `63be634de4baf64dc85da3a3ca168933676ba94a2d4b89553da7db18bd03ca4d`
10. SOFAction receipt — `sof-workspace://mcp-adopter-20260811a/matrix/agent-b/action/validation-receipt.json` — `447c62bf1a1800318051907539bc36339974e68df2f2f2ddedf60e4f0cf34fe2`

Strongest justified stage claims: realization validates the declared finite typed realization but not adapter adequacy; reporting certifies thresholded direct support within its declared representation; comparison observes one alignment-relative mismatch; interpretation certifies only policy-relative bounded candidate generation; receipts establish protocol/artifact closure only.

## Complete MCP transcript

This is the archival replay of the admitted workflow. Each entry records the
exact tool name, exact arguments, and exact returned `structuredContent`.
...
```json
{
  "tool": "mcp__sof_runtime__sof_get_contract",
  "args": {
...
```json
{
  "tool": "mcp__sof_runtime__sof_realize",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "case_directory": "case/reference",
    "run_directory": "matrix/agent-b/reference-realization",
    "request_id": "agent-b-archive-realize-reference"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-realize-reference",
    "job_id": "job:b9cb8e8129fc4912ad1e671cad0df28f",
    ...
    "artifacts": [
      {
        ...
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/realization/candidate.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/adapter/declaration.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/adapter/inspection.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/realization/evidence.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-realization/run-receipt.json",
...
```json
{
  ...
  "args": {
    ...
    "run_directory": "matrix/agent-b/target-realization",
    "request_id": "agent-b-archive-realize-target"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-realize-target",
    "job_id": "job:3ad20d3a1a0b450b910f632cf522c88c",
    ...
    "artifacts": [
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/realization/candidate.json",
      ...
      },
      {
        "artifact_id": "adapter_declaration:7284ed390f68c27f",
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/adapter/declaration.json",
        "sha256": "7284ed390f68c27f370bc7470ab3e351b0922150145e01e2a89c34bb158b69d4",
        "schema_id": null,
        "producer": "sof-runtime.service@0.3.0.dev0",
        "input_refs": []
      },
      {
        "artifact_id": "source_inspection:2e2f51bbdcf95b71",
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/adapter/inspection.json",
        "sha256": "2e2f51bbdcf95b71a4ebf0ef6fa7fc1a332c79c638946ab5312d8823eaac34f2",
        "schema_id": null,
        "producer": "sof-runtime.service@0.3.0.dev0",
        "input_refs": []
      },
      {
        "artifact_id": "realization_evidence:383b067ca5eda48f",
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/realization/evidence.json",
        "sha256": "383b067ca5eda48f82603d3a12fff091085e0ba99a399a8b2e99c4f7efa97158",
        "schema_id": null,
        "producer": "sof-runtime.service@0.3.0.dev0",
        "input_refs": []
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-realization/run-receipt.json",
...
```json
{
  "tool": "mcp__sof_runtime__sof_report",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "realization_run_directory": "matrix/agent-b/reference-realization",
    "out_directory": "matrix/agent-b/reference-report",
    "request_id": "agent-b-archive-report-reference"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-report-reference",
    "job_id": "job:e419d30074d04e4ca68b2aa8b805f99e",
    ...
    "artifacts": [
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-report/report/result.sofreport.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/reference-report/report/validation-receipt.json",
...
```json
{
  ...
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "realization_run_directory": "matrix/agent-b/target-realization",
    "out_directory": "matrix/agent-b/target-report",
    "request_id": "agent-b-archive-report-target"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-report-target",
    "job_id": "job:f9a6b40ff63b4391bc1df03b8b943ab4",
    ...
    "artifacts": [
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-report/report/result.sofreport.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/target-report/report/validation-receipt.json",
...
```json
{
  "tool": "mcp__sof_runtime__sof_validate",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "validation_kind": "sofrs",
    "artifact": "matrix/agent-b/reference-report/report/result.sofreport.json",
    "request_id": "agent-b-archive-validate-reference-report"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-reference-report",
    "job_id": "job:eeb4efb741ad41f9a0e3c9f0e238f955",
...
```json
{
  ...
  "args": {
    ...
    "artifact": "matrix/agent-b/reference-report/report/validation-receipt.json",
    "request_id": "agent-b-archive-validate-reference-receipt"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-reference-receipt",
    "job_id": "job:6497dc3dab6e41bbb2da821eed8875bc",
...
```json
{
  ...
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "validation_kind": "sofrs",
    "artifact": "matrix/agent-b/target-report/report/result.sofreport.json",
    "request_id": "agent-b-archive-validate-target-report"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-target-report",
    "job_id": "job:c4b7fca6fa5747808d2cdf0687b9f519",
...
```json
{
  ...
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "validation_kind": "sofrs_receipt",
    "artifact": "matrix/agent-b/target-report/report/validation-receipt.json",
    "request_id": "agent-b-archive-validate-target-receipt"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-target-receipt",
    "job_id": "job:7da7e9779bab4883a2e4b1b3915c207f",
...
```json
{
  "tool": "mcp__sof_runtime__sof_compare",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "reference_report": "matrix/agent-b/reference-report/report/result.sofreport.json",
    "reference_receipt": "matrix/agent-b/reference-report/report/validation-receipt.json",
    "target_report": "matrix/agent-b/target-report/report/result.sofreport.json",
    "target_receipt": "matrix/agent-b/target-report/report/validation-receipt.json",
    "alignment": "case/comparison/alignment.json",
    "comparison_profile": "comparison-profile.json",
    "out_directory": "matrix/agent-b/comparison",
    "request_id": "agent-b-archive-compare"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-compare",
    "job_id": "job:1091860b2f80495bb94828e3b958d353",
    ...
    "artifacts": [
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/comparison/result.sofaudit.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/comparison/validation-receipt.json",
...
```json
{
  ...
  "args": {
    ...
    "artifact": "matrix/agent-b/comparison/result.sofaudit.json",
    "request_id": "agent-b-archive-validate-audit"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-audit",
    "job_id": "job:bef31c081f19426fa43d3a81e34db238",
...
```json
{
  ...
  "args": {
    ...
    "artifact": "matrix/agent-b/comparison/validation-receipt.json",
    "request_id": "agent-b-archive-validate-audit-receipt"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-audit-receipt",
    "job_id": "job:ccb05de055d04395ba6c27f88bf784ef",
...
```json
{
  "tool": "mcp__sof_runtime__sof_interpret",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "audit": "matrix/agent-b/comparison/result.sofaudit.json",
    "receipt": "matrix/agent-b/comparison/validation-receipt.json",
    "context": "case/action/context.json",
    "policy": "case/action/policy.json",
    "out_directory": "matrix/agent-b/action",
    "request_id": "agent-b-archive-interpret"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-interpret",
    "job_id": "job:58f612a762ca4acf9abc50bb67104db7",
    ...
    "artifacts": [
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/action/result.sofaction.json",
      ...
      },
      {
        ...
        "media_type": "application/json",
        "uri": "sof-workspace://mcp-adopter-20260811a/matrix/agent-b/action/validation-receipt.json",
...
```json
{
  ...
  "args": {
    ...
    "artifact": "matrix/agent-b/action/result.sofaction.json",
    "request_id": "agent-b-archive-validate-action"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-action",
    "job_id": "job:913a60214c0b4e33a3c41404bdff3ddf",
...
```json
{
  ...
  "args": {
    ...
    "artifact": "matrix/agent-b/action/validation-receipt.json",
    "request_id": "agent-b-archive-validate-action-receipt"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-validate-action-receipt",
    "job_id": "job:1e2df52e777b4f19a2c17dee7853933f",
...
```json
{
  "tool": "mcp__sof_runtime__sof_get_artifact",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "path": "matrix/agent-b/action/result.sofaction.json",
    "sha256": "63be634de4baf64dc85da3a3ca168933676ba94a2d4b89553da7db18bd03ca4d"
  },
  "structuredContent": {
    "artifact": {
...
```json
{
  "tool": "mcp__sof_runtime__sof_get_receipt",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "path": "matrix/agent-b/action/validation-receipt.json",
    "sha256": "447c62bf1a1800318051907539bc36339974e68df2f2f2ddedf60e4f0cf34fe2"
  },
  "structuredContent": {
    "artifact": {
...
```json
{
  "tool": "mcp__sof_runtime__sof_explain",
  "args": {
    "workspace_id": "mcp-adopter-20260811a",
    "run_directory": "matrix/agent-b",
    "request_id": "agent-b-archive-explain"
  },
  "structuredContent": {
    "contract_id": "sof-runtime.service-response.v1",
    "request_id": "agent-b-archive-explain",
    "job_id": "job:bd26d15d23c04f82b7ca29eea4c67fb3",
    ...
    "result": {
      "explanation": {
        ...
        "run_id": "agent-b",
        "run_directory": "<server-workspace>\\mcp-adopter-20260811a\\matrix\\agent-b",
        "workflow": "full_pipeline",
        "realizations": [
          {
            "stage": "realization",
            "run_receipt": {
              "uri": "<server-workspace>\\mcp-adopter-20260811a\\matrix\\agent-b\\reference-realization\\run-receipt.json"
            },
            "source": {
              "uri": "runs/.sof-service-cache/40/40341dd55e28c2d0fc558412a57c27a9fc8b27ed5786b1a5111dec28752cb60b/realize/source/input.json",
              "digest": {
          ...
          },
          {
            "stage": "realization",
            "run_receipt": {
              "uri": "<server-workspace>\\mcp-adopter-20260811a\\matrix\\agent-b\\target-realization\\run-receipt.json"
            },
            "source": {
              "uri": "runs/.sof-service-cache/33/3351436f2103027ee29cfb406c14f3b60f086de79f00c8ebe2ff38cd5db6113e/realize/source/input.json",
              "digest": {
        ...
        "comparison": {
          ...
          "audit_id": "comparison.example.finite-state-adapter.finite-state.transition.reference.sofreport.example.finite-state-adapter.finite-state.transition.target.sofreport",
          "artifact": {
            "uri": "<server-workspace>\\mcp-adopter-20260811a\\matrix\\agent-b\\comparison\\result.sofaudit.json"
          },
          "validation": {
            "status": "PASS",
            "receipt_id": "receipt.comparison.example.finite-state-adapter.finite-state.transition.reference.sofreport.example.finite-state-adapter.finite-state.transition.target.sofreport.sofaudit-v2",
        ...
        "interpretation": {
          ...
          "action_record_id": "action.comparison.example.finite-state-adapter.finite-state.transition.reference.sofreport.example.finite-state-adapter.finite-state.transition.target.sofreport",
          "artifact": {
            "uri": "<server-workspace>\\mcp-adopter-20260811a\\matrix\\agent-b\\action\\result.sofaction.json"
          },
          "validation": {
            "status": "PASS",
            "receipt_id": "receipt.action.comparison.example.finite-state-adapter.finite-state.transition.reference.sofreport.example.finite-state-adapter.finite-state.transition.target.sofreport.sofaction-v2",
